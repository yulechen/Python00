...
if __name__ == '__main__':
   # main('localhost', 2222, '2B 48 42 44 E1 1B 56 15 5D 02 04 59 57 08 07 E0 0B 11 0F 1C 28 76 3B B9 4F 0D 0A')
    main('172.16.1.16', 4567, '2B 48 42 44 E1 1B 56 15 5D 02 04 59 57 08 07 E0 0B 11 0F 1C 28 76 3B B9 4F 0D 0A')
